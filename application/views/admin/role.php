        ...
        <!-- Modal -->
        <div class="modal fade" id="RoleManagement" tabindex="-1" aria-labelledby="RoleManagementLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="RoleManagementLabel">Add New Role</h5>
